...
SELECT * FROM PROJETO;
INSERT INTO PROJETO (NOME,RESPONSAVEL,INICIO,FIM) VALUES ('SENAC','G123','27/02/24','')

SELECT C.MATRICULA,C.NOME,P.NOME FROM COLABORADOR C
INNER JOIN PROJETO P ON C.MATRICULA=P.RESPONSAVEL
